            ...
            <div className="max-w-full sm:max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl 2xl:max-w-screen-2xl mx-auto relative">
                ...
                <div className="flex h-screen justify-center items-center">
                    <div className="bg-white flex flex-col mt-20 md:mt-0 p-5 md:p-10 pb-20 rounded-lg w-fit h-fit text-center">
                        ...
                        <p className="my-5 font-semibold">Department Login</p>
                ...
                <div className="mt-20 h-fit bg-red-500 relative">
                    <div className="absolute bottom-0 left-0">
                        <div className="h-fit max-w-full p-4 sm:max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl 2xl:max-w-screen-2xl mx-auto">
                            <Link href={'/auth/instituteLogin'}><PrimaryButton className={'w-full md:w-fit hover:scale-95'} textClass={'text-xs lg:text-sm 2xl:text-lg'}>INSTITUTION LOGIN</PrimaryButton></Link>
                        </div>
                    </div>
                </div>
            </div>
