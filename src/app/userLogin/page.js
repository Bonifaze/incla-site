      ...
      <div className="max-w-full sm:max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl 2xl:max-w-screen-2xl mx-auto">
        <div className="lg:grid lg:grid-cols-2 text-white relative h-screen">
          <div className="p-6 md:p-10">
            ...
            <div className="flex flex-col md:flex-row gap-7 md:gap-10 mt-24 md:mt-16">
              <a href="https://portal.InCLA.edu.ng/staff/login" target="_blank" rel="noopener noreferrer">
                <PrimaryButton className={'bg-white border-2 border-white w-full hover:bg-zinc-100 hover:scale-95'} textClass={'!text-black text-xs lg:text-sm 2xl:text-lg text-nowrap'}>LECTURER LOGIN</PrimaryButton>
              </a>
              <a href="https://portal.InCLA.edu.ng/students/login" target="_blank" rel="noopener noreferrer">
        ...
        <div className="bg-white absolute bottom-0 left-0 w-screen">
          <div className="w-screen h-fit p-6 max-w-full sm:max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl 2xl:max-w-screen-2xl mx-auto">
            <a href="https://portal.InCLA.edu.ng/staff/login" target="_blank" rel="noopener noreferrer">
              <PrimaryButton className={'w-full md:w-fit hover:scale-95'} textClass={'text-xs lg:text-sm 2xl:text-lg'}>ADMIN LOGIN</PrimaryButton>
            </a>
          </div>
        </div>
      </div>
