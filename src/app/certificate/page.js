export default function Certificate () {
    return (
        <div>
            <div className="bg-cert h-[170px] md:h-[300px] lg:h-[400px] max-h-[800px] bg-[#66165a]/55 bg-blend-overlay w-full bg-top bg-no-repeat bg-cover text-lg md:text-2xl lg:text-4xl font-bold text-white 2xl:text-6xl flex items-center justify-center">
                <h1>Certificate Courses</h1>  
            </div> 
            <div className="flex flex-col items-center bg-[#f2f2f2] p-4 md:p-7">
                <div className="flex flex-col justify-center items-center gap-5 max-w-full sm:max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl 2xl:max-w-screen-2xl mx-auto">
                    <div className="bg-white rounded-lg p-5 md:p-10 text-black w-full leading-relaxed mt-5 lg:mt-10"
                        style={{
                    ...
                    <div className="bg-white rounded-lg p-4 md:p-7 text-black w-full leading-relaxed my-5 lg:mt-10"
                        style={{
                            boxShadow: "0px 4px 4px 0px #00000040",
                        }} 
                    >
                        ...
                        <ul className="list-disc list-inside">
                            ...
                            <li>The relationship between leading and management.</li>
                            <li>Analysis of personal leadership style.</li>
                            <li>Managing conflict
                                <ul className="list-disc list-inside ml-4">
                                    <li>Respond to conflict</li>
                                    <li>Effective measures for preventing conflicts.</li>
                                    <li>Top tips on managing conflicts network place.</li>
                                    <li>Managing the body language during conflict.</li>
                                </ul>
                            </li>
                            <li>Building Social Awareness and interpersonal effectiveness
                                <ul className="list-disc list-inside ml-4">
                                    <li>Evaluating the impact of emotion on performance</li>
                                    <li>Facilitation effective communication in work place.</li>
                                </ul><br />
                            </li>
                        </ul>
                        <p>There is also a program for Certificate in Counselling Psychology</p>
                    </div>
                </div>
            </div>
        </div>
